...
/*
 * This cell subclass is intended to be used together with CarouselBannerView
 * This class adds a method used to scale the cell in relation to the cell's position in the top level window.
 * Collection view cells used with CarouselBannerView should subclass this type
 */

open class CarouselBannerCVC: UICollectionViewCell {
    ...
    override open func layoutSubviews() {
        ...
        guard let carouselView = superview as? CarouselBannerView else { return }
